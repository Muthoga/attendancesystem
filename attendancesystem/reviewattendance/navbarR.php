...
<!--Navbar for files inside reviewattendance folder -->
<style>
	#teacherinfo{
		margin-right: 2em;
		display: inline-flex;
...
<nav class="navbar navbar-expand-sm navbar-dark fixed-top" style="margin-bottom:80px">
  ...
  <a class="navbar-brand" href="../dash.php" style="color: #ECF0F1;"><img src="../assets/logogreen.png" alt="Logo" style="width:1.5em; margin: 0% 10% 0% 2%;">&nbsp;B2BAtt</a>
