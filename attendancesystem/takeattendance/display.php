...
<html>
	...
	<body style="background: #FFFFFF;">
		...
		<div class="row">
			<div class="col-12">
			<img src="./../assets/zetech.png" class="left pull-left" height="200px" width="300px">
			...
			<div class="col-12">
				<?php
					...
					echo("<center><img id='qrimg' src='../assets/qrcode/".$year.$coursename."-".$division."/qrcode.png' style='margin-bottom:100px' alt='QR_Code'></center>");
				?>
				<div class="datahead">
					<?php 
