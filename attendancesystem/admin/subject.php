...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <a href="admin.php" class="navbar-brand abs"><img src="../assets/logogreen.png" height="30" width="30"> Zetech Attendance</a>
    ...
    <div class="navbar-collapse collapse justify-content-stretch" id="navbar7">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="teacher.php">Lecturer</a>
...
<form class="form" action="subjectadd.php" method="post" style="width:50%;">
<td>
<input class="form-control" name="classid" type="number" required></input>
</td>
<td>
<input class="form-control" name="subname" id="txt" type="text" required></input>
</td>
</tr>
</tbody>
</table>
